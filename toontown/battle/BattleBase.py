...
SQUIRT = SQUIRT_TRACK
DROP = DROP_TRACK
TOON_ATTACK_TIME = 1000.0
SUIT_ATTACK_TIME = 1000.0
TOON_TRAP_DELAY = 0.8
TOON_SOUND_DELAY = 0.0
TOON_THROW_DELAY = 0.5
TOON_THROW_SUIT_DELAY = 0.3
TOON_SQUIRT_DELAY = 0.5
TOON_SQUIRT_SUIT_DELAY = 0.3
TOON_DROP_DELAY = 0.8
TOON_DROP_SUIT_DELAY = 0.3
TOON_RUN_T = 3.3
TIMEOUT_PER_USER = 5
TOON_FIRE_DELAY = 0.5
TOON_FIRE_SUIT_DELAY = 0.3
REWARD_TIMEOUT = 120
