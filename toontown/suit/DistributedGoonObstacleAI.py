...
from toontown.suit.DistributedObstacleBaseAI import DistributedObstacleBaseAI
from toontown.suit import GoonPathData
from toontown.suit.GoonGlobals import *


class DistributedGoonObstacleAI(DistributedObstacleBaseAI):
    UPDATE_TIMESTAMP_INTERVAL = 180.0
    STUN_TIME = 4
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedGoonObstacleAI')
    ...
    def __init__(self, air):
        ...
        self.velocity = 4
        self.scale = 1.0
        DistributedObstacleBaseAI.__init__(self, air)
        self.curInd = 0
    ...
    def delete(self):
        ...
        DistributedObstacleBaseAI.delete(self)

    def generate(self):
        self.notify.debug('generate')
        DistributedObstacleBaseAI.generate(self)
    ...
    def doCrush(self, crusherId, axis):
        ...
        DistributedObstacleBaseAI.doCrush(self, crusherId, axis)
        self.crushed = 1
        self.grid.removeObject(self.entId)
