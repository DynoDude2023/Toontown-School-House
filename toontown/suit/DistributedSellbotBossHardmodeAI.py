...
from toontown.building import SuitPlannerInteriorHardmodeAI
...
class DistributedSellbotBossHardmodeAI(DistributedBossCogAI.DistributedBossCogAI, FSM.FSM):
    ...
    def invokeSuitPlanner(self, buildingCode, skelecog):
        planner = SuitPlannerInteriorHardmodeAI.SuitPlannerInteriorHardmodeAI(1, buildingCode, self.dna.dept, self.zoneId)
