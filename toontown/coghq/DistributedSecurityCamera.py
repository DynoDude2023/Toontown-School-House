...
class DistributedSecurityCamera(BasicEntities.DistributedNodePathEntity):
    ...
    def __init__(self, cr):
        ...
        self.onSound = loader.loadSfx('phase_11/audio/sfx/ttr_s_ara_lhq_camera_shutter_2.ogg')
        ...
        self.moveStartSound = loader.loadSfx('phase_11/audio/sfx/ttr_s_ara_lhq_laser_beam_on_2.ogg')
        self.moveStartTrack = Parallel(SoundInterval(self.moveStartSound, node=self, volume=0.4))
        self.moveLoopSound = loader.loadSfx('phase_11/audio/sfx/ttr_s_ara_lhq_laser_beam_hum_2.ogg')
        self.moveLoopSound.setLoop()
        self.moveLoopTrack = Parallel(SoundInterval(self.moveLoopSound, node=self, volume=0.4))
        self.moveStopSound = loader.loadSfx('phase_11/audio/sfx/ttr_s_ara_lhq_laser_beam_off_2.ogg')
